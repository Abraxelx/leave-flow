...
public class QuickAddLeaveController {
    ...
    private void loadLeaveTypes() {
        ...
        leaveTypeCombo.setValue("Yıllık İzin"); // Varsayılan
    }
    ...
    private void setupDefaults() {
        ...
        // İlk çalışanı seç
        if (!employeeCombo.getItems().isEmpty()) {
            employeeCombo.setValue(employeeCombo.getItems().get(0));
        }
    }
